...
const BENEFITS = [
  { title: "Fast turnaround", sub: "Staff placed in days, not weeks — ideal for sudden demand or cover." },
  { title: "Fully flexible", sub: "Scale up or down as your workload changes, with no long-term commitment." },
  { title: "Try before you hire", sub: "See how someone performs on the job before considering them permanently." },
];

const PROCESS = [
  { step: "1", title: "Tell us the need", sub: "Shift patterns, headcount, and start date." },
  { step: "2", title: "We source", sub: "Pulled from our pool of vetted, ready-to-work candidates." },
  { step: "3", title: "Staff placed", sub: "Compliant, briefed, and ready for their first shift." },
  { step: "4", title: "Ongoing support", sub: "We manage cover, swaps, and any issues throughout the assignment." },
];
    ...
    <main className="overflow-x-hidden font-body">
      ...
      <section className="relative isolate min-h-[420px] overflow-hidden bg-navy">
        <div className="absolute inset-0">
          <Image src="/industries/lookingforwork.png" alt="Temporary worker on shift" fill sizes="100vw" className="object-cover object-top" priority />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
          ...
          <div className="mt-6 max-w-lg">
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-orange">Temporary recruitment</p>
            <h1 className="font-display mt-3 text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
              Flexible staff, whenever you need them.
            </h1>
            <p className="mt-4 text-sm text-white/70 sm:text-base">
              Cover shortages, seasonal peaks, or short-term projects with ready-to-work staff.
            </p>
            <Link href="/book-a-call" className="mt-6 flex w-fit items-center gap-1.5 rounded-full bg-orange px-6 py-3 text-sm font-bold text-white transition hover:bg-orange-dark">
              Get staff now <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <h2 className="font-display text-2xl font-extrabold text-navy">Why go temporary</h2>
      ...
      <section className="bg-navy py-14">
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-orange">Need cover fast?</p>
            <h2 className="font-display mt-3 text-2xl font-extrabold text-white sm:text-3xl">
              Let&rsquo;s get you staffed.
            </h2>
          </div>
