...
const ROLES = [
  "HGV Class 1 (C+E) drivers",
  "HGV Class 2 (C) drivers",
  "7.5t drivers",
  "LGV and multi-drop delivery drivers",
  "ADR-certified drivers",
  "Owner-drivers and agency drivers",
];

const WHY_POINTS = [
  { title: "Fully vetted", sub: "Every driver is licence-checked, DBS-screened where required, and reference-verified." },
  { title: "Fast turnaround", sub: "Urgent cover or planned shifts — we move quickly to keep your routes running." },
  { title: "Compliance-first", sub: "CPC, tachograph, and working-time regulations handled properly, every time." },
];
    ...
    <main className="overflow-x-hidden font-body">
      ...
      <section className="relative isolate min-h-[420px] overflow-hidden bg-navy">
        <div className="absolute inset-0">
          <Image src="/industries/industry-driving.png" alt="Driver at work" fill sizes="100vw" className="object-cover object-top" priority />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
          ...
          <div className="mt-6 max-w-lg">
            <p className="text-xs font-bold uppercase tracking-[0.25em] text-orange">Driving recruitment</p>
            <h1 className="font-display mt-3 text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
              Drivers who keep your operation moving.
            </h1>
            <p className="mt-4 text-sm text-white/70 sm:text-base">
              HGV, LGV, 7.5t and ADR drivers — vetted, compliant, and ready when you need them.
            </p>
            <Link href="/book-a-call" className="mt-6 flex w-fit items-center gap-1.5 rounded-full bg-orange px-6 py-3 text-sm font-bold text-white transition hover:bg-orange-dark">
              Hire drivers now <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <h2 className="font-display text-2xl font-extrabold text-navy">Why choose us for driver recruitment</h2>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <h2 className="font-display mt-3 text-2xl font-extrabold text-white sm:text-3xl">
              Let&rsquo;s find your next driver.
            </h2>
          </div>
